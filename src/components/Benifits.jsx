  ...
  return (
    <div className="flex flex-col justify-center items-center gap-[56px] px-[16px] pt-[120px] pb-[64px] lg:px-[80px] lg:py-[120px]">
      ...
      <div className="flex lg:hidden">
        <img src={access} alt="" className="w-[480px] h-[312px]" />
      </div>
      <div className="flex flex-col lg:flex-row justify-center gap-10 lg:gap-[48px]">
        <div className="flex flex-col justify-between items-end gap-10 lg:py-6">
          <BenifitCard
            logo={search}
            title={"Control Exposure Safely"}
            body={
              "Customizable leverage, full control, amplified yield, and peace of mind."
            }
          />
          <BenifitCard
            logo={growthblue}
        ...
        <div className="flex flex-col justify-between items-start gap-10 lg:gap-8 lg:py-6">
          <BenifitCard
            logo={clock}
            title={"Lucrative Low Risk Capital Allocation"}
            body={
              "Spiral Stake makes low-risk DeFi more lucrative, easy, and safer than bonds or idle stables."
            }
          />
          <BenifitCard
            logo={gas}
